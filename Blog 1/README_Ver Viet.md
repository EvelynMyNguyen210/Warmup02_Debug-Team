...
# **4. Các phương pháp AD phổ biến**

Sự gia tăng nhanh chóng của dữ liệu từ nhiều nguồn khác nhau đã khiến việc phát hiện bất thường (AD) ngày càng trở nên thiết yếu để xác định những quan sát bất thường có thể báo hiệu lỗi hệ thống, vi phạm an ninh hoặc gian lận. Hiện nay có rất nhiều phương pháp AD từ đơn giản đến phức tạp, từ truyền thống đến hiện đại. Mỗi phương pháp đều có những ưu và nhược điểm riêng. Tuỳ vào loại dữ liệu và mục đích, mà các doanh nghiệp hay các tổ chức sẽ lựa chọn những phương pháp phù hợp.
...
GNN coi mỗi biến trong chuỗi thời gian đa biến như một nút để nắm bắt các mối quan hệ phức tạp giữa các chiều khác nhau. Mặc dù trọng tâm chính ở đây là khả năng dự đoán của GNN, nhưng cần lưu ý rằng chúng cũng hiệu quả trong việc phát hiện bất thường dựa trên tái tạo. Quyết định cuối cùng về việc chuỗi đầu vào có bất thường hay không chủ yếu dựa trên sai số dự đoán hoặc sự khác biệt về cấu trúc đồ thị, với sai số tái tạo đóng vai trò là dấu hiệu bổ sung. 
...
Các phương pháp dựa trên tái tạo và dựa trên dự đoán cung cấp các cách tiếp cận riêng biệt nhưng bổ sung cho nhau để xác định các bất thường. Cả hai phương pháp đều dựa vào sự khác biệt giữa đầu ra của mô hình và dữ liệu đầu vào thực tế như một chỉ báo về sự bất thường. Tuy nhiên, chúng khác nhau về cách xử lý dữ liệu và lĩnh vực ứng dụng. 

Các phương pháp dựa trên tái tạo tập trung vào việc học phân bố cơ bản của dữ liệu bình thường. Sau khi được huấn luyện, mô hình cố gắng tái tạo dữ liệu đầu vào. Sai số tái tạo, được đo bằng sự khác biệt giữa dữ liệu gốc và dữ liệu được tái tạo, đóng vai trò là một chỉ báo quan trọng về các bất thường. Sai số tái tạo cao cho thấy dữ liệu lệch khỏi các mẫu bình thường mà mô hình đã học được. Cách tiếp cận này đặc biệt hiệu quả trong các trường hợp cần hiểu đầy đủ cấu trúc hoặc phân bố của dữ liệu, chẳng hạn như trong AD dựa trên hình ảnh hoặc các tập dữ liệu đa chiều khác. 

Ngược lại, các phương pháp dựa trên dự đoán tập trung vào việc dự báo các thuộc tính cụ thể hoặc các giá trị bị thiếu từ dữ liệu, thay vì tái tạo toàn bộ đầu vào. Các phương pháp này thường dự đoán các giá trị trong tương lai hoặc suy luận các điểm dữ liệu bị thiếu bằng cách tận dụng các đặc điểm đã biết. Nếu các giá trị được dự đoán khác biệt đáng kể so với các giá trị thực tế, điều này báo hiệu một bất thường tiềm ẩn. Các phương pháp dựa trên dự đoán thường phù hợp hơn với các tập dữ liệu giàu tính năng, nơi việc dự đoán các biến cụ thể có thể giúp xác định các mẫu bất thường. Ví dụ, trong các ứng dụng như phát hiện gian lận, việc dự đoán hành vi hoặc giao dịch dự kiến có thể tiết lộ các bất thường khi kết quả dự đoán khác với kết quả quan sát được. 

Mặc dù cả hai phương pháp đều khác nhau về cách tiếp cận xử lý dữ liệu, nhưng chúng có thể bổ sung cho nhau rất tốt. Trong nhiều trường hợp, việc kết hợp các kỹ thuật dựa trên tái cấu trúc và dựa trên dự đoán trong một khung lai cho phép phát hiện bất thường mạnh mẽ hơn. Các mô hình tái cấu trúc nắm bắt cấu trúc và mẫu tổng thể trong dữ liệu, trong khi các mô hình dự đoán tập trung vào việc phát hiện sự sai lệch trong các biến hoặc tính năng cụ thể. Sự kết hợp này có thể cung cấp một giải pháp toàn diện hơn để xác định các bất thường trong các tập dữ liệu phức tạp trên nhiều lĩnh vực khác nhau. 
